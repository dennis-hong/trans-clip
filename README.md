...
![TransClip Screenshot](https://img.shields.io/badge/Platform-macOS-blue) ![Version](https://img.shields.io/badge/Version-0.1.11-green) ![License](https://img.shields.io/badge/License-MIT-yellow)
...
[**📦 최신 버전 다운로드 (v0.1.11)**](https://github.com/dennis-hong/trans-clip/releases/latest)

위 링크에서 `TransClip_0.1.11_aarch64.app.zip` 파일을 다운로드하세요.

### 2. 설치 방법

1. 다운로드한 `TransClip_0.1.11_aarch64.app.zip` 파일의 압축을 해제합니다
